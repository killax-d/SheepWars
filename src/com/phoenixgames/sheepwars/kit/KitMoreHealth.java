...
public class KitMoreHealth extends KitSheepWars {

	public KitMoreHealth(){
		super();
	}
	
	public KitMoreHealth(Player player, int level){
		super(player, level);
	}
	
	@Override
	public String getName() {
		return EnumTranslate.MORE_HEALTH.getTranslation(getLang());
	}

	@Override
	public List<String> getDescription() {
		return TextUtils.parseLine(EnumTranslate.DESC_MORE_HEALTH.getTranslation(getLang()));
	}
	...
	public Statistics getStats() {
		return new Statistics(12 + (1*(getLevel()-1)), 1.0F, 1.0F, 0.0F);
	}
