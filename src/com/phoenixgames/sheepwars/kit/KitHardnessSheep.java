...
public class KitHardnessSheep extends KitSheepWars {

	public KitHardnessSheep(){
		super();
	}
	
	public KitHardnessSheep(Player player, int level){
		super(player, level);
	}
	
	@Override
	public String getName() {
		return EnumTranslate.HARDNESS_SHEEP.getTranslation(getLang());
	}

	@Override
	public List<String> getDescription() {
		return TextUtils.parseLine(EnumTranslate.DESC_HARDNESS_SHEEP.getTranslation(getLang()));
	}
	...
	public Statistics getStats() {
		return new Statistics(10 + (1*(getLevel()-1)), 1.0F, 1.0F + (0.15F * getLevel()), 0.0F);
	}
