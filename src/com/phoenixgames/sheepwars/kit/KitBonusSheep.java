...
public class KitBonusSheep extends KitSheepWars {

	public KitBonusSheep(){
		super();
	}
	
	public KitBonusSheep(Player player, int level){
		super(player, level);
	}
	
	@Override
	public String getName() {
		return EnumTranslate.BONUS_SHEEP.getTranslation(getLang());
	}

	@Override
	public List<String> getDescription() {
		return TextUtils.parseLine(EnumTranslate.DESC_BONUS_SHEEP.getTranslation(getLang()));
	}
	...
	public Statistics getStats() {
		return new Statistics(8 + (1*(getLevel()-1)), 1.0F, 1.0F, 0.0F + (0.10F * getLevel()));
	}
